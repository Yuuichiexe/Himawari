...
from Mizuharabot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from Mizuharabot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Mizuharabot.modules.helper_funcs.msg_types import get_welcome_type
from Mizuharabot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Mizuharabot.modules.log_channel import loggable
from Mizuharabot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not Mizuharabot.ALLOW_CHATS:
